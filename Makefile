...
test: test-phpstan test-phpcs ## Execute application tests
...
migrate:
	$(docker_compose_bin) exec -T -u $(shell id -u) "$(PHP_CLI_CONTAINER_NAME)" ./user-api/apps/main/bin/console doctrine:migrations:migrate
