...
namespace UserApi\UserApiKernel;
...
use UserApi\Core\Common\Exception\InvalidArgumentException;
use UserApi\Core\Context\Application\Service\ApplicationServiceInterface;
...
class Kernel
{
    ...
    protected function getServiceFromRequest(Request $request): ApplicationServiceInterface
    {
        try {
            ...
            $service = \UserApi\Apps\Main\ServiceLocator::getService($serviceName);
        } catch (\Exception $e) {
